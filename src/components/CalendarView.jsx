...
import { ChevronLeft, ChevronRight, Plus, CheckCircle, Calendar as CalendarIcon, X, Clock, CheckSquare, Trash2, User, Edit2 } from 'lucide-react';
      ...
      if (editItemId) {
        if (viewMode === 'deadlines') {
          ...
          sendNotification({
            ...
            module: 'calendar',
            targetUid: newEventAssignee || 'all',
            type: 'warning'
          });
