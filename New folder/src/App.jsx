      ...
      {isMobile && (
        <nav className="mobile-bottom-nav" role="navigation" aria-label="Main navigation">
          ...
          <button
            ...
            aria-label="Tasks"
          >
            <div className={`mobile-nav-tab__icon-wrap ${badges?.evoboard > 0 ? 'animate-icon-ring' : ''}`}>
              ...
              {badges?.evoboard > 0 && <span className="mobile-nav-badge">{badges.evoboard > 9 ? '9+' : badges.evoboard}</span>}
            </div>
