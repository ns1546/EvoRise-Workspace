...
const Pagination = ({ currentPage, totalItems, itemsPerPage, onPageChange, onItemsPerPageChange }) => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 24px', background: 'white', borderRadius: '16px', border: '1px solid var(--glass-border)', flexWrap: 'wrap', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        {/* Jump to page */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '12px', paddingLeft: '12px', borderLeft: '1px solid var(--glass-border)' }}>
          <span style={{ fontSize: '12px', color: 'var(--text-secondary)', fontWeight: 600 }}>Jump:</span>
          <input 
            type="number" 
            min="1" 
            max={totalPages}
            ...
            style={{ width: '50px', padding: '6px', borderRadius: '8px', border: '1px solid var(--glass-border)', fontSize: '13px', textAlign: 'center', outline: 'none', fontWeight: 600, background: 'var(--bg-matte)' }}
          />
        </div>
      </div>
    </div>
