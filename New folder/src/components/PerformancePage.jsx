    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      {selectedTaskDetails && (
        <div onClick={() => setSelectedTaskDetails(null)} style={{ position: 'fixed', inset: 0, zIndex: 99999, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: isMobile ? 'flex-end' : 'center', justifyContent: 'center', padding: isMobile ? '0' : '20px' }}>
          <div className={isMobile ? "mobile-bottom-sheet" : ""} onClick={e => e.stopPropagation()} style={{ width: isMobile ? '100%' : '800px', maxWidth: '100%', maxHeight: isMobile ? '70dvh' : '90vh', background: 'white', borderRadius: isMobile ? '24px 24px 0 0' : '24px', display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', animation: 'float-in 0.3s ease-out' }}>
