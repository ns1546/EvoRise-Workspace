      ...
      <div style={{ display: 'flex', flexDirection: 'column', background: '#F2F2F7', minHeight: '100%' }}>
        ...
        {isModalOpen && (
          <>
            ...
            <div style={{ position: 'fixed', height: '70dvh', bottom: 0, left: 0, right: 0, zIndex: 301, background: color, borderRadius: '24px 24px 0 0', padding: '20px 20px calc(24px + env(safe-area-inset-bottom))', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
